...
- `bubble_sort.py` / `quick_sort.py` / `comparacao.py` — Parte 2, experimento de ordenação
- `busca_sequencial.py` — Parte 3, busca em matriz
- `temperaturas.py` — Parte 4, Hands On 1 (array)
- `sensores.py` — Parte 5, Hands On 2 (matriz)
